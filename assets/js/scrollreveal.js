        ...
        ScrollReveal().reveal('nav ul,.sponsor-title,.wedo-title,',{delay:500 , origin : 'top',interval : 100,distance:'50px'}); 
        ...
        ScrollReveal().reveal('.session-popular .swiper,.contact-right,.img-learn,.img-learn-2',{delay : 600 , origin : 'bottom',distance:'70px'});
        ScrollReveal().reveal('.review-box,.certificate-box',{delay : 700 , origin:'bottom',distance:'70px',interval:100});
